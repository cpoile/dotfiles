;;; zenburn-theme-colors.el -*- lexical-binding: t; -*-
;; set rainbow-mode to see colors

;; from https://github.com/bbatsov/zenburn-emacs/blob/master/zenburn-theme.el
